...
public class FankuiWebActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String tgc = (String) SPUtils.get(FankuiWebActivity.this, "TGC", "");
                ...
                if (grantResults.length > 0)
                {
                    for (int result : grantResults)
                    {
                        if (result != PackageManager.PERMISSION_GRANTED)
                        {
                            ...
                            TestShowDig.AskForPermission(FankuiWebActivity.this,"");
                            return;
                        }
                    }
    ...
    private void getMyLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION) ==
            ...
            if (location!=null){
                ...
                SPUtils.put(FankuiWebActivity.this,"latitude",latitude+"");
                SPUtils.put(FankuiWebActivity.this,"longitude",longitude+"");
                ...
                if(locationList != null && locationList.size() > 0){
                    ...
                    for (int i = 0; address.getAddressLine(i) != null; i++) {
                        ...
                        SPUtils.put(FankuiWebActivity.this,"addressLine",addressLine);
                    }
                }else {
                    SPUtils.put(FankuiWebActivity.this,"latitude","");
                    SPUtils.put(FankuiWebActivity.this,"longitude","");
                    SPUtils.put(FankuiWebActivity.this,"addressLine","");
                }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            webView.setLoadFinishListener(new CLWebView.LoadFinishListener() {
                ...
                public void onLoadFinish(WebView webView) {
                    ...
                    Log.e("myurl","加载结束了");
                    Log.e("myurl",url1);
                    String downLoadType = (String) SPUtils.get(FankuiWebActivity.this, "downLoadType", "");
    ...
    private void logOut(final String urldown) {
        ...
        rl_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tag = 1;
                mAgentWeb = AgentWeb.with(FankuiWebActivity.this)
                        .setAgentWebParent(mLinearLayout, new LinearLayout.LayoutParams(-1, -1))
                        .useDefaultIndicator(-1, 3)//设置进度条颜色与高度，-1为默认值，高度为2，单位为dp。
                        ...
                        .setMainFrameErrorView(R.layout.agentweb_error_page, -1)
                        .setSecurityType(AgentWeb.SecurityType.STRICT_CHECK)
                        .setWebLayout(new WebLayout4(FankuiWebActivity.this))
                        .setOpenOtherPageWays(DefaultWebClient.OpenOtherPageWays.ASK)//打开其他应用时，弹窗咨询用户是否前往其他应用
                        .interceptUnkownUrl() //拦截找不到相关页面的Scheme
                        .setAgentWebWebSettings( getSettings())//设置 IAgentWebSettings。
                        .createAgentWeb()
    ...
    protected DownloadListenerAdapter mDownloadListenerAdapter = new DownloadListenerAdapter() {
        ...
        public boolean onStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength, AgentWebDownloader.Extra extra) {
            ...
            ViewUtils.createLoadingDialog(FankuiWebActivity.this);
        ...
        public boolean onResult(String path, String url, Throwable throwable) {
            ...
            if (null == throwable) { //下载成功
                ...
                new Share2.Builder(FankuiWebActivity.this)
...
//            AgentWebConfig.clearDiskCache(this.getContext());
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            //关闭震动
            SoundPoolUtils.virateCancle(FankuiWebActivity.this);
    ...
    public void imeiTask(String invocationLogAppId, String invocationLogFunction) {
        if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_PHONE_STATE)) {
            ...
            EasyPermissions.requestPermissions(this, "获取设备权限",
                    RC_CAMERA_PERM, Manifest.permission.READ_PHONE_STATE);
        }
    }
...
//                            BaseWebActivity.this.finish();
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(Response<String> response) {
                            ...
                            if(success == true){
                                ...
                                ToastUtils.showToast(FankuiWebActivity.this,"没有使用该功能的权限!");
                                /*deliver.post(new Runnable() {
                                    @Override
                                    public void run() {
                                        onLoctionCoordinate();
    ...
    public void cameraTask() {
        if (EasyPermissions.hasPermissions(FankuiWebActivity.this, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            // Have permission, do the thing!
