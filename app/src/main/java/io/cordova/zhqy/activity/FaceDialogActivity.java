...
public class FaceDialogActivity extends BaseActivity3 {
    ...
    private FaceDialogActivity.MySensorListener mySensorListener;
    ...
    protected void initView() {
        ...
        tv_pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(FaceDialogActivity.this,CertificateActivateNextTwoActivity.class);
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    String s = bitmapToBase64(scaledBitmap);
                     ...
                     Log.e("人脸",s+"");
                    SPUtils.put(FaceDialogActivity.this,"bitmap",s);
                    Intent intent = new Intent();
                    intent.setAction("faceDialog");
