...
//            AgentWebConfig.clearDiskCache(this.getContext());
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (success) {
                            ...
                            if (null != obj) {
                                String rolecodes = (String) SPUtils.get(BaseWebActivity4.this, "rolecodes", "");
                                ...
                                if(showFlag == 1){//有权限弹出CA DialogActivity
                                    ...
                                    Intent intent = new Intent(BaseWebActivity4.this, DialogActivity.class);
                                    ...
                                    //ToastUtils.showToast(BaseWebActivity4.this,"当前用户无操作权限");
                                    SignCAResultBean signCAResultBean = new SignCAResultBean();
                                    signCAResultBean.setSuccess(true);
    ...
    private void testTakePhoto() {
        ...
        if(Build.VERSION.SDK_INT>=24){
            fileUri1= FileProvider.getUriForFile(BaseWebActivity4.this,"io.cordova.zhqy.provider",mPhotoFile);
