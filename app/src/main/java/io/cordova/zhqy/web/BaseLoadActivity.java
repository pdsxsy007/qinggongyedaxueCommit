...
public class BaseLoadActivity extends SupportActivity implements GestureDetector.OnGestureListener,PermissionsUtil.IPermissionsCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        downLoadType = (String) SPUtils.get(BaseLoadActivity.this, "downLoadType", "");
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location){
            ...
            if(addressLine != null){
                SPUtils.put(BaseLoadActivity.this,"addressLine",addressLine);
            }
            if(country != null){
                SPUtils.put(BaseLoadActivity.this,"country",country);
            }

            if(countryCode != null){
                SPUtils.put(BaseLoadActivity.this,"countryCode",countryCode);
            }

            if(province != null){
                SPUtils.put(BaseLoadActivity.this,"province",province);
            }

            if(city != null){
                SPUtils.put(BaseLoadActivity.this,"city",city);
            }

            if(cityCode != null){
                SPUtils.put(BaseLoadActivity.this,"cityCode",cityCode);
            }

            if(district != null){
                SPUtils.put(BaseLoadActivity.this,"district",district);
            }

            if(adcode != null){
                SPUtils.put(BaseLoadActivity.this,"adcode",adcode);
            }

            if(street != null){
                SPUtils.put(BaseLoadActivity.this,"street",street);
            }

            if(streetNumber != null){
                SPUtils.put(BaseLoadActivity.this,"streetNumber",streetNumber);
            }
            if(town != null){
                SPUtils.put(BaseLoadActivity.this,"town",town);
            }

            SPUtils.put(BaseLoadActivity.this,"latitude",latitude+"");
            SPUtils.put(BaseLoadActivity.this,"longitude",longitude+"");
            SPUtils.put(BaseLoadActivity.this,"altitude",altitude+"");
            SPUtils.put(BaseLoadActivity.this,"speed",speed+"");
            SPUtils.put(BaseLoadActivity.this,"direction",direction+"");
            SPUtils.put(BaseLoadActivity.this,"locationWhere",locationWhere+"");
        }
    }
...
/*
    ...
    private void initListener() {
        ...
        rbSc.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                m_Dialog_browser = new MyDialog(BaseLoadActivity.this, R.style.DialogTheme);

                View view1 = LayoutInflater.from(BaseLoadActivity.this).inflate(R.layout.dialog_browser, null);
                ...
                mLinearLayoutManager = new LinearLayoutManager(BaseLoadActivity.this, LinearLayout.HORIZONTAL,false);
                ...
                BrowserAdapter browserAdapter = new BrowserAdapter(BaseLoadActivity.this,R.layout.item_browser,list);
    ...
    private void copyString(String appServiceUrl) {
        ...
        ToastUtils.showToast(BaseLoadActivity.this,"复制成功!");
    }
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            view.loadUrl(appServiceUrl);// 避免出现默认的错误界面
            view.removeAllViews();
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            String downLoadType = (String) SPUtils.get(BaseLoadActivity.this, "downLoadType", "");
    ...
    private void logOut(final String urldown) {
        ...
        rl_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tag = 1;
                mAgentWeb = AgentWeb.with(BaseLoadActivity.this)
                        .setAgentWebParent(mLinearLayout, new LinearLayout.LayoutParams(-1, -1))
                        .useDefaultIndicator(-1, 3)//设置进度条颜色与高度，-1为默认值，高度为2，单位为dp。
                        ...
                        //.setMainFrameErrorView(R.layout.agentweb_error_page, -1)
                        .setSecurityType(AgentWeb.SecurityType.STRICT_CHECK)
                        .setWebLayout(new WebLayout4(BaseLoadActivity.this))
                        .setOpenOtherPageWays(DefaultWebClient.OpenOtherPageWays.ASK)//打开其他应用时，弹窗咨询用户是否前往其他应用
                        .interceptUnkownUrl() //拦截找不到相关页面的Scheme
    ...
    protected DownloadListenerAdapter mDownloadListenerAdapter = new DownloadListenerAdapter() {
        ...
        public boolean onResult(final String path, String url, final Throwable throwable) {
            ...
            if (null == throwable) { //下载成功
                ...
                new Share2.Builder(BaseLoadActivity.this)
...
//            AgentWebConfig.clearDiskCache(this.getContext());
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            //关闭震动
            SoundPoolUtils.virateCancle(BaseLoadActivity.this);
    ...
    public class AndroidInterface {
        ...
        public void nativeGetLocation(final String invocationLogAppId,final String invocationLogFunction,final String needExtraInfo) {
                ...
                if (EasyPermissions.hasPermissions(BaseLoadActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
        ...
        public void nativeGetPicture(final String ratio,final String invocationLogAppId,final String invocationLogFunction) {
            if (EasyPermissions.hasPermissions(BaseLoadActivity.this, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
        ...
        public void nativeGetEquipmentId(final String invocationLogAppId,final String invocationLogFunction) {
            if (EasyPermissions.hasPermissions(BaseLoadActivity.this, Manifest.permission.READ_PHONE_STATE)) {
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(Response<String> response) {
                            ...
                            if(success == true){
                                ...
                                ToastUtils.showToast(BaseLoadActivity.this,"没有使用该功能的权限!");
                                /*deliver.post(new Runnable() {
                                    @Override
                                    public void run() {
                                        onLoctionCoordinate();
    ...
    private void testTakePhoto() {
        ...
        if(Build.VERSION.SDK_INT>=24){
            fileUri1= FileProvider.getUriForFile(BaseLoadActivity.this,"io.cordova.zhqy.provider",mPhotoFile);
                                ...
                                if(typeName.equals(invocationLogFunction)){
                                    if(invocationLogFunction.equals("nativeVerifyUserAndFace")){
                                        deliver.post(new Runnable() {
                                            @Override
                                            public void run() {
                                                SPUtils.put(BaseLoadActivity.this,"bitmap","");
                                                Intent intent = new Intent(BaseLoadActivity.this,FaceYiQingActivity.class);
            ...
            if(action.equals("facereYiQing")){
                ...
                if(imageid == 0){
                    if(FaceActivity != null){
                        ...
                        String s = (String)SPUtils.get(BaseLoadActivity.this, "bitmap", "");
                        String imei = (String) SPUtils.get(BaseLoadActivity.this, "imei", "");
                        String username = (String) SPUtils.get(BaseLoadActivity.this, "phone", "");
...
//                            BaseWebActivity.this.finish();
    ...
    public void onLoctionCoordinate(){
        ...
        locationBean.setSignRecordEquipmentId(MobileInfoUtils.getIMEI(BaseLoadActivity.this));
    ...
    protected void onResume() {
       // mAgentWeb.getWebLifeCycle().onResume();
        ...
        netInsertPortal("5");
        String isLoading2 = (String) SPUtils.get(BaseLoadActivity.this, "isloading2", "");
        Log.e("isLoading2",isLoading2);
        if(!isLoading2 .equals("")){
            ViewUtils.createLoadingDialog2(BaseLoadActivity.this,true,"人脸识别中");
            SPUtils.put(getApplicationContext(),"isloading2","");
